package com.yurkiv.pianoflow.view;
...
public class PlayPauseView extends FrameLayout {
    ...
    public PlayPauseView(Context context, AttributeSet attrs) {
        ...
        mPauseBackgroundColor = getResources().getColor(R.color.primary_color);
        mPlayBackgroundColor = getResources().getColor(R.color.primary_color);
    }
